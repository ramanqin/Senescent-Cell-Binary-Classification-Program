...
def main():
    ...
    parser.add_argument("--group0-size", type=int, default=50, help="Aging/0 quota; -1 means all, 0 means none")
    parser.add_argument("--group1-size", type=int, default=50, help="Young/1 quota; -1 means all, 0 means none")
